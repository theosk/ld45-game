...
BEGIN
    ...
    state_dialog_putline("You are near the orc settlement...", 400);
    state_dialog_putline("Orcs are tougher than bandits, but also richer.", 400);
...
BEGIN
    ...
    state_dialog_putline("You defeated lots of orcs. You explore their lands.", 400);
    state_dialog_putline("You find where they hide their treasure...", 400);
    state_dialog_putline("", 400);

    sound_play(snd.win);
    state_dialog_putline("New area unlocked: Orc treasure room", 400);
